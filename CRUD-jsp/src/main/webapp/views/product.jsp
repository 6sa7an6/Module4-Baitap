                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <c:forEach items="${list}" var="product">
                                <tr>
                                    ...
                                    <td>${product.price}</td>
                                    <td>${product.stock}</td>
                                    <td>${product.status?"Dang ban" : "Ngung ban"}</td>
                                    <td><a href="/product-controller/edit?id=${product.id}" class="btn btn-warning">Edit</a></td>
                                    <td><a href="/product-controller/delete?id=${product.id}" class="btn btn-danger">Delete</a></td>
                                </tr>
                            </c:forEach>
                            </tbody>
