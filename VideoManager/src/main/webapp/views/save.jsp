    ...
    <form action="/save" method="post">
        <c:if test="${song.id != null}">
            ...
            <select name="status" class="form-select" aria-label="Default select example">
                <option value="true" ${song.status ? 'selected' : ''}>Show</option>
                <option value="false" ${!song.status ? 'selected' : ''}>Hidden</option>
            </select>
            <%--<div class="form-floating">
                <input type="text" class="form-control" name="status" id="floatingShow" placeholder="Show/Hidden"
                       value="${song.status}">
                <label for="floatingShow">Status</label>
            </div>--%>
            <%--<select name="status" class="form-select" aria-label="Default select example">
